...
interface IPrinter {   
    ...
    */
	 ...
	 * </ul>
	 */
    int setPageSize(in Bundle format); //打印设置
	 ...
	 * @param text - 打印文本
	 */
    int addText(in Bundle format, String text); //打印文本
	 ...
	 * @param qrCode - 二维码内容
	 */
	  int addQrCode(in Bundle format, String qrCode); //打印二维码
	 ...
	 */
    int addImage(in Bundle format, String imageData); //打印图像
