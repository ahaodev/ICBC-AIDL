...
public class PagePrinter extends IPrinter.Stub implements CSNIOCallBack {
    ...
    private Printer.Builder printerBuilder = new Printer.Builder();
...
//        mPos.POS_FeedLine();
        csnCanvas.DrawText(text,0,0,0,null,fontSize,0);
    ...
    public int addQrCode(Bundle format, String qrCode) throws RemoteException {
        ...
        csnCanvas.DrawQRCode(qrCode, -1, -1, 0,10,0,1);
        return 0;
    }
